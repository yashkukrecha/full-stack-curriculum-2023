...
const apiKey = 'edeb07750fa8aa3873fec2b01f33084b'; // Your OpenWeatherMap API key here
  ...
  return (
    <div className="app-container">
      ...
      */}
      ...
      <MainContainer apiKey={apiKey} city={city}/* Pass the selected city data as props to 'MainContainer' */ />
